...
class DataArguments:
    ...
    """
    data_path: Optional[str] = field(default=None, metadata={"help": "The chat template to use."})
    use_key: Optional[str] = field(default=None, metadata={"help": "The chat template to use."})
