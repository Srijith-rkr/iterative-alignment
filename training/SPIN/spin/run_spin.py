...
sys.path.append(str(wd.parent.parent/'trl_GH'))


# import trl_GH.trl as trl
import torch
import transformers
...
def main():
    ...
    spin_trainer = SPINTrainer(
        model,
        ref_model=None, # SRIJIH : CHANGED THIS 
    ...
    ##################################
    spin_trainer.save_model(os.path.join(training_args.output_dir,'final_ckpt'))
