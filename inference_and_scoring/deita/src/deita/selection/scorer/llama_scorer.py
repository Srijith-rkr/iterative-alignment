...
class Llama_Scorer(Scorer):
    ...
    @property
    def half_quality_template(self):
        
        quality_template = ("You are a helpful assistant. Please identify the quality score of the Question. \n #Question#:\n{instruction} \n##Quality: ")
        
        return quality_template
    
    @property
    def full_complexity_template(self):
        
        complexity_template = ("You are a helpful assistant. Please identify the complexity score of the following user query and response. \n##Query: {instruction}\n#Response#:\n{output} \n##Complexity: ")
